...
import { formularioLogin, autentication, formularioRegister, register, confirm, formularioPasswordRecovery , passwordReset, veryTokenPasswordChange, updatePassword} from '../controllers/userController.js';
...
router.post('/register', (req, res, next)=>{console.log("Enviando la informacion para crear el nuevo usuario..."); next();}, register);//para saber rastrear una aplicaccion (Debuguear)
...
router.get('/passwordRecovery/:token', veryTokenPasswordChange);
